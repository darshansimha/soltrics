...
<body>
    ...
    <!-- navbar -->
     <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            ...
            <a class="brand" href="dashboard.php">Soltrics</a>
            <ul class="nav">            
   ...
   <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li>
                <a class="dropdown-toggle" href="courses/schedule.php">
                    <i class="icon-time"></i>
            ...
            <li>
                <a class="dropdown-toggle" href="courses/coursecontent.php?cid=<?php echo $cid;?>">
			...
			<li>
                <a class="dropdown-toggle" href="takequiz.php">
                    <i class="icon-bullseye"></i>
                    <span>Quizzes</span>
    ...
    <div class="content">
        <div class="container-fluid" style="margin-top: 20px;">
             <div id="pad-wrapper">
                   ...
                   <div class="span8">
                   <img src="<?php $image=$crow['image'];echo $image;?>"><br><br>
                   <h2 style="font-family:bebas;" ><?php $title=$crow['title'];echo $title;?></h2>
                   <hr></div>
                   <div class="span8"><h3>Home</h3><br></br>
                   <p><?php $summary=$crow['summary']; echo $summary;?></p></div>
