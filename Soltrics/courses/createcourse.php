...
if(!empty($_POST['title'])){
	...
	$query="insert into course(title,category,inst,author,session,work,summary,syllabus,faqs,image,video,pre,format,readings) values
	('$title','$category','$inst','$author','$session','$work','$summary','$syllabus','$faqs','$image','$video','$pre','$format','$readings')";
...
<body>
	...
	<!-- main container -->
    <div class="content">
    <div id="bluebanner"><img src="img/banner.jpg" style="
    margin-left: .49px;
    height: 176px;
"></div>
                        ...
                        <div class="step-content">
                            <div class="step-pane active" id="step1">
                                <div class="row-fluid form-wrapper">
                                    <div class="span8">
                                        <form name="f1" method="post" action="createcourse.php" enctype="multipart/form-data">
                                            <div class="field-box">
                                                <label>Title:</label>
                                            ...
                                            <div class="field-box">
                                                ...
                                                <select name="category" style="width:250px;" class="select2">
                                                    <option></option>
                                            ...
                                            <div class="field-box">
                                               <label>Course Session</label>
                                                <select name="session" style="width:250px;margin-left:1px;" class="select2" placeholder="Select weeks">
                                                    <option></option>
                                ...
                                <div class="row-fluid form-wrapper">
                                    <div class="span8">
                                            ...
                                            <div class="field-box">
												...
												<input type="file" name="syllabus" class="span8">
											   </div>
