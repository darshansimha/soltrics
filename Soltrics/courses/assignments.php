...
$sql="select * from files where cid='$cid'";
$res=mysql_query($sql);
?>
                ...
                <table class=" table table-hover  span8 " style="text-align:center;margin-top:30px;">
                  ...
                  <tbody>
				   <tr>
                      <td>Chemical 101</td>
                      <td>17-7-2013</td>
                      <td><button class="btn btn-primary">Attempt</button></td>
                    </tr>
                    <tr>
                      <td>Chemical 101</td>
                      <td>17-7-2013</td>
					...
					$i=1;
					$aname="Assignment".$i;
					$assgn=$row['assignment'];
                    echo "<tr><td>$aname</td>
                      <td>$date</td>
                      <td><a href='."$assgn."'<button class='btn btn-primary'>Take Assignment</button></a></td>
                    </tr>";
					$i++;
					}
                    ?>
